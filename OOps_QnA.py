...
Extensibility: Add new sources/transformers/sinks without modifying existing code
Testability: Each component can be tested independently
Reusability: Components can be mixed and matched for different pipelines
Maintainability: Clear structure, easy to understand and modify
Scalability: Can add parallel processing, error handling, monitoring easily
...
Singleton: Only one instance (Database connection)
...
Using mutable default arguments (def __init__(self, items=[]))
Not using super().__init__() in inheritance
Modifying class variables when you meant instance variables
Overusing inheritance instead of composition
Not implementing __repr__ for debugging
Catching too broad exceptions in methods
Not validating input in property setters
